...
related: [wiki/concepts/data-models, wiki/concepts/transactions-acid, wiki/concepts/replication, wiki/topics/databases, wiki/sources/designing-data-intensive-applications]
---
...
- [[wiki/concepts/data-models]] — the logical layer above physical storage
- [[wiki/concepts/transactions-acid]] — B-tree WAL is part of durability; isolation requires careful coordination with storage
- [[wiki/concepts/replication]] — replication logs (WAL shipping, logical logs) are built on top of the storage layer
